        ...
        try:
            ...
            for pair_no,(bd,ad) in enumerate(pairs,1):
                ...
                for pm in page_matches:
                    if pm.status == "NO_MATCH": continue
