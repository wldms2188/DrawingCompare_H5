...
class ImageLoader:
    ...
    def _render_page(self, page, pdf_path: Path, page_index: int) -> PageImage:
        # Render from PDF vectors at high DPI; do not screenshot then upscale.
        ...
        return PageImage(pdf_path, page_index, image, w, h, original_width, original_height,
    ...
    def get_page_metadata(self, page: PageImage) -> dict:
        ...
        return {"page_index": page.page_index, "width": page.width, "height": page.height,
                "aspect_ratio": page.aspect_ratio, "page_hash": page.page_hash,
                "ink_ratio": float(np.count_nonzero(binary) / binary.size), "orientation": 0}
